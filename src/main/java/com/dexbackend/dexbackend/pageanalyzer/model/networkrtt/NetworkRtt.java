...
public class NetworkRtt {
	...
	/** The network rtt details. */
	NetworkRttDetails networkRttDetails;

	/**
	 * Instantiates a new network rtt.
	 */
	public NetworkRtt() {
		super();
		networkRttDetails = new NetworkRttDetails();
	}
	...
	/**
	 * Gets the network rtt details.
	 *
	 * @return the network rtt details
	 */
	public NetworkRttDetails getNetworkRttDetails() {
		return networkRttDetails;
	}

	/**
	 * Sets the network rtt details.
	 *
	 * @param networkRttDetails the new network rtt details
	 */
	public void setNetworkRttDetails(NetworkRttDetails networkRttDetails) {
		this.networkRttDetails = networkRttDetails;
	}
